...
public class SidePanel extends JPanel {
     ...
     */
    private static final int TEXT_STRIDE = 15;
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("" + tetris.getLevel(), 100, 155);
        g.drawString("" + tetris.getScore(), 100, 245);

        g.setFont(LARGE_FONT);
        g.drawString("", SMALL_INSET, offset = CONTROLS_INSET);
        ...
        if (!tetris.isGameOver() && type != null) {
             ...
             */
            int startX = (145 - (cols * TILE_SIZE / 2));
            int startY = (40 - (rows * TILE_SIZE / 2));
 		...
 		/*
		 * Draw a preview of piece on hold
        */
        type = tetris.getSavedPieceType();
        if (!tetris.isGameOver() && type != null) {
            /*
			 * Get the size properties of the current piece.
             */
			 ...
			 * Calculate the top left corner (origin) of the piece.
             */
            int startX = (150 - (cols * TILE_SIZE / 2));
            int startY = (100 - (rows * TILE_SIZE / 2));
